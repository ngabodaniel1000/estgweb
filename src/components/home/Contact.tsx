        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
                ...
                <form className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        type="text"
                        id="name"
                        className="w-full rounded-md border border-input px-4 py-2.5 focus:border-estg-blue focus:ring-1 focus:ring-estg-blue outline-none transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      id="message"
                      rows={5}
                      className="w-full rounded-md border border-input px-4 py-2.5 focus:border-estg-blue focus:ring-1 focus:ring-estg-blue outline-none transition-colors resize-none"
            ...
            <AnimatedSection animation="slide-up" className="lg:col-span-2">
              <div className="bg-estg-gray-light rounded-2xl p-8">
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  ...
                  <div className="flex space-x-3">
                    <a href="#" className="p-2.5 bg-white rounded-full shadow-sm hover:bg-estg-blue hover:text-white transition-colors">
