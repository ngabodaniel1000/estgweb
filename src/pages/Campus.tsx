        ...
        <div className="container px-4">
          <AnimatedSection animation="slide-up" className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground">
              Experience our vibrant campus community and world-class facilities designed to support your academic journey.
            </p>
          </AnimatedSection>
        </div>
      </div>
      ...
      <div className="py-16 md:py-24 bg-white">
        <div className="container px-4">
          <AnimatedSection animation="fade-in" className="text-center">
            <p className="text-xl text-estg-blue">Campus Page Content Coming Soon</p>
          </AnimatedSection>
        </div>
      </div>
